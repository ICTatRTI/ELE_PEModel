...
parameters
        ...
        fomcost(r,u)            fixed O&M ($ per kW) /* MEEDE FOM_gen -- need to convert from $ to $ per kW*/
        vomcost(r,u)            variable O&M ($ per MWh) /* MEEDE VOM_gen -- need to convert from $ to $ per MWh*/
        ...
        dele(r,t)               annual demand (TWh) /* NEEDE  */

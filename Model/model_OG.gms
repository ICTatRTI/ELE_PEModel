...
**--- Include sets ---**
$include 'EMA\Model\sets_OG.gms'


**--- Include data ---**
$include 'EMA\Model\data_OG.gms'
...
* save results
$include 'EMA\Model\findings_OG.gms'

* save results
$batinclude 'EMA\Model\Output\report_OG.gms' %scn%
...
File generation_dat /.\EMA\Model\Results\EMA_output_generation_OG.csv/,
        demand_seg_dat /.\EMA\Model\Results\EMA_output_demandseg_OG.csv/,
        capacity_dat /.\EMA\Model\Results\EMA_output_capacity_OG.csv/,
        transmission_dat /.\EMA\Model\Results\EMA_output_transmission_OG.csv/,
        emissions_dat /.\EMA\Model\Results\EMA_output_emissions_OG.csv/,
        demand_reg_dat /.\EMA\Model\Results\EMA_output_demandreg_OG.csv/;

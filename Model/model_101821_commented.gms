...
**--- Include sets ---**
$include 'EMA\Model\sets.gms'


**--- Include data ---**
$include 'EMA\Model\data.gms'
...
*cap_limit("slrPV_N",t)          = sum(r,capacity(r,"slr_X","2020")) * (1.15)**(t.val-2020);
*cap_limit("slrCSP_N",t)         = sum(r,capacity(r,"slr_X","2020")) * (1.15)**(t.val-2020);

*cap_limit("wnd_N",t)            = sum(r, capacity(r,"wnd_X","2020")) * (1.10)**(t.val-2020);
...
*$if %scn%==carbtax      carbtax(t)$(t.val ge 2025)      = %carbtax% * (1.05)**(t.val - 2025);
...
*        + sum((rr,l), Transmit(r,rr,l,t) * 0 * 1e-3)
...
*c_RsrvMargin(r,t)$(t.val gt 2020)..
...
*GEN.up(r,baseu,"2020",l,t)$feasible(r,baseu,"2020",t)   = capacity(r,baseu,"2020") * hours(r,l) * maxCF(r,baseu,l) * 1e-3;

*INV.fx(r,u,v,t)$(not newu(u))                           = 0;
*INV.fx(r,u,"2020",t)$(not ngtbN(u))                     = 0;
* PTS no new nuclear
...
* save results
$include 'EMA\Model\findings.gms'

* save results
$batinclude 'EMA\Model\Output\report.gms' %scn%


execute_unload 'EMA\Model\Output\EMF_ELEC_results_%scn%.gdx',EMF_elec;

execute_unload 'EMA\Model\Output\results_%scn%.gdx', USAphy%scn%,USAdlr%scn%;
...
* OUTPUTS
File generation_dat /.\EMA\Model\Results\EMA_output_generation_test.csv/,
*        wholesale_dat /.\EMA\Model\Results\EMA_output_wholesale.csv/,
*        wholesale_seg_dat /.\EMA\Model\Results\EMA_output_wholesale_seg.csv/,
*        chk_dat /.\EMA\Model\Results\EMA_output_chk.csv/,
*        demand_seg_dat /.\EMA\Model\Results\EMA_output_demandseg_caplimit.csv/,
        capacity_dat /.\EMA\Model\Results\EMA_output_capacity_test.csv/,
*        transmission_dat /.\EMA\Model\Results\EMA_output_transmission_caplimit.csv/,
*        emissions_dat /.\EMA\Model\Results\EMA_output_emissions_caplimit.csv/,
*        demand_reg_dat /.\EMA\Model\Results\EMA_output_demandreg_caplimit.csv/,
*        retirement_dat /.\EMA\Model\Results\EMA_output_retirement.csv/;
        fomcost_dat /.\EMA\Model\Results\EMA_output_fomcost_test.csv/,
        vomcost_dat /.\EMA\Model\Results\EMA_output_vomcost_test.csv/;
...
*put chk_dat;
*put 'region,load_segment,time,value'/;
*loop((r,l,t), put r.tl:0,',':0,l.tl:0,',':0,t.tl:0,',':0,chk_price(r,l,t):0:2 /);
...
*loop((i,j), put i.tl:0,',':0, j.tl:0,',':0, x.l(i,j):0:2 /);
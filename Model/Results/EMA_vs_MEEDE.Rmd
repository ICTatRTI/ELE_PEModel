...
#for (r in REGIONS) {
#  p = comparison_bargraphs(MEEDE_data, EMA_data, y_var = "total_cost", region = r, plant_type_filter = #PLANT_TYPES, ylim = ylim_cost)
...
# for (r in REGIONS) {
#   p = comparison_bargraphs(MEEDE_data, EMA_data, y_var = "fixed_cost", region = r, plant_type_filter = PLANT_TYPES, ylim = 6000)
#   
#   print(p)
# }
...
# for (r in REGIONS) {
#   p = comparison_bargraphs(MEEDE_data, EMA_data, y_var = "variable_cost", region = r, plant_type_filter = PLANT_TYPES, ylim = 4000)
#   
#   print(p)
# }
